...
class HyperNetwork(nn.Module):
    def __init__(
        self, hyper_in_features, hyper_hidden_layers, hyper_hidden_features, hypo_module
    ):
        """
...
class NeuralProcessImplicit2DHypernet(nn.Module):
    ...
    def __init__(
        self, in_features, out_features, image_resolution=None, encoder_nl="sine"
    ):
        super().__init__()
        ...
        self.set_encoder = modules.SetEncoder(
...
class ConvolutionalNeuralProcessImplicit2DHypernet(nn.Module):
    def __init__(
        self, in_features, out_features, image_resolution=None, partial_conv=False
    ):
        super().__init__()
        latent_dim = 256
