...
class CIFAR100ClassDataset(ClassDataset):
    ...
    def __init__(
        ...
        super(CIFAR100ClassDataset, self).__init__(
        ...
        self.split_filename_labels = os.path.join(
            self.root, self.subfolder, self.filename_labels.format(self.meta_split)
        )
        self._data = None
        self._labels = None
    ...
    def download(self):
        ...
        download_url(
            self.download_url, self.root, filename=gz_filename, md5=self.gz_md5
        )
